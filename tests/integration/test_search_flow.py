...
async def test_full_search_flow():
    ...
    assert "MIA" in final_output or "card" in final_output.lower() or "cost" in final_output.lower() or "vibe" in final_output.lower() or "smooth" in final_output.lower(), "Final output should reflect the trip details, A2UI cards, or vibe."
